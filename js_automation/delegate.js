...
if (LOCAL) {
    ...
    contract_address = "0x589B5Dd96F8eCEc870c94c91B732B66f3d7719fb"
...
(async () => {
    ...
    const data = c.methods.pwn().encodeABI(); // abi encoded request to the contract

    const rawTransaction = {
        "nonce": int2hex(await w3.eth.getTransactionCount(a.address)),
    ...
    console.log('Sending')
    await w3.eth.sendSignedTransaction(`0x${serializedTx.toString('hex')}`)
    console.log('Sent')
